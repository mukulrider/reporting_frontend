...
class SampleBarChart extends React.PureComponent { // eslint-disable-line react/prefer-stateless-function
  ...
  createChart = (data,id) => {
    ...
    var margin = {top: 10, right: 20, bottom: 120, left: 20},
      width = containerWidth - margin.left - margin.right*2,
      height = containerWidth*0.9 - margin.top - margin.bottom*2;
